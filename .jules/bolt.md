...
**Action:** Always audit `apt` install lists in CI workflows to ensure only necessary packages are installed. Document expected time savings (estimated ~45s in this case).
