...
KibaOS is a lightweight Linux distribution built on **Arch Linux base (Rolling)** with **Deepin Desktop Enviroment** as the desktop environment. It is developed and maintained by **WolfTech Innovations**.
...
- [**Manual Compilation**](./docs/manual-compilation.md): Building the Deepin Desktop Enviroment from source.
...
- **Modern Desktop:** **Deepin Desktop Enviroment** with **Wayland** as the default session.
