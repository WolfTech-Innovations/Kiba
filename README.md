...
<p align="center">
<img width="1330" height="519" alt="KibaTV Desktop Preview" src="https://github.com/user-attachments/assets/e4a14aef-f23e-4890-96a5-86c34b31f5d8" />
</p>
...
KibaTV is a lightweight Linux distribution built on **Debian 13 (Trixie)** with **KDE Plasma 6** as the desktop environment. It is developed and maintained by **WolfTech Innovations**.
...
docker run --rm --privileged \
  ...
  -e RUN_NUM=local \
  debian:trixie \
  /w/scripts/kibatv_build.sh
```

> [!NOTE]
> The `scripts/kibatv_build.sh` script contains the full configuration and customization hooks.
...
├── scripts/
│   └── kibatv_build.sh        # Core build orchestration script
├── branding/
│   └── kibaos_banner.png      # KibaTV brand assets
