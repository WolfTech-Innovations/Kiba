...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:hover, .card:focus-within { transform:translateY(-3px); box-shadow:0 8px 32px rgba(0,100,160,0.14); }
...
<main>
  ...
  <section>
    ...
    <br>
    <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" target="_blank" rel="noopener noreferrer" aria-label="View KibaOS Wiki (opens in new tab)">Wiki</a>
    ...
    <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="View KibaOS source code on GitHub (opens in new tab)">GitHub</a>
