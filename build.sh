...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card {
    ...
    transition: transform .15s, box-shadow .15s, outline-offset .1s;
    cursor: default;
  }
  ...
  .btn {
    ...
    margin:6px 6px 0 0; transition: background .12s, transform .1s, outline-offset .1s;
    cursor: pointer;
  }
...
<section>
  ...
  <br>
  <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" target="_blank" rel="noopener noreferrer" aria-label="Visit KibaOS Wiki (opens in a new tab)">Wiki</a>
  ...
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="View KibaOS source on GitHub (opens in a new tab)">GitHub</a>
