...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .card{background:var(--surface);border-radius:16px;padding:24px;flex:1;min-width:220px;box-shadow:0 2px 12px rgba(0,0,0,.08);transition:transform .2s,box-shadow .2s}
  ...
  .tip kbd{background:#fff;padding:2px 6px;border:1px solid #d8e0e2;border-radius:4px;box-shadow:0 1px 1px rgba(0,0,0,.1);font-family:monospace}
  .btn{display:inline-block;background:var(--teal);color:#fff;border-radius:10px;padding:10px 22px;text-decoration:none;font-size:.9rem;font-weight:600;margin-right:8px;margin-top:8px;transition:background .2s,box-shadow .2s;outline:none}
...
<main>
  <div class="card-row" role="list">
    <div class="card" role="listitem"><h2>Budgie Desktop</h2><p>Modern, clean, and intuitive. Fully Wayland-native on Budgie 10.10.</p></div>
  ...
  <section>
    ...
    <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/issues" aria-label="Report a bug or request a feature on GitHub">Report Issue</a>
