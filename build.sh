...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .btn { display:inline-block; background:var(--accent); color:#fff; border-radius:10px; padding:9px 20px; text-decoration:none; font-size:.88rem; font-weight:600; margin:6px 6px 0 0; cursor:pointer; transition:background .12s, transform .1s, box-shadow .1s; }
...
<footer>KibaOS Rolling — WolfTech Innovations — <a href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="KibaOS GitHub (opens in a new tab)" style="color:inherit; text-decoration:underline;">github.com/WolfTech-Innovations/Kiba</a></footer>
</body>
</html>
WELCOMEHTML
