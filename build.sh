...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:focus-visible, .btn:focus-visible { outline: 2px solid var(--accent); outline-offset: 2px; }
  .card:active, .btn:active { transform: scale(0.96); transition: transform 0s; }
