...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .btn {
    ...
    cursor: pointer;
    transition: background 220ms cubic-bezier(0.5, 0, 0.75, 0), transform 0.1s;
  }
  ...
  .btn.secondary { background:var(--surface); color:#0077aa; border:1.5px solid var(--border); }
  .btn.secondary:hover, .btn.secondary:focus-visible { background:#e6f6fc; }
...
<section>
  ...
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba/issues" target="_blank" rel="noopener noreferrer" aria-label="Report Issue (opens in a new tab)">🛠️ Report Issue</a>
...
<footer>
  ...
  <a href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="Kiba GitHub Repository (opens in a new tab)">github.com/WolfTech-Innovations/Kiba</a>
</footer>
</body>
</html>
WELCOMEHTML
