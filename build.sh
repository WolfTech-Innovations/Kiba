...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .btn {
    ...
    transition: background .12s, outline-color .2s;
...
<header>
  ...
  <main>
    ...
    <section>
      ...
      <br>
      <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" aria-label="Visit KibaOS Wiki">Wiki</a>
      ...
      <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" aria-label="View KibaOS source code on GitHub">GitHub</a>
