...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:focus-visible { box-shadow: 0 0 0 3px rgba(0,153,204,0.3), 0 8px 32px rgba(0,100,160,0.14); }
  ...
  .btn {
    ...
    margin:6px 6px 0 0; transition: background .12s, transform .1s, box-shadow .12s;
    outline: none; border: none; cursor: pointer;
  }
  .btn:hover { background:var(--accent-dark); }
  .btn:focus-visible { box-shadow: 0 0 0 3px rgba(0,153,204,0.4); }
...
<section>
  ...
  <br>
  <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" target="_blank" rel="noopener noreferrer" aria-label="Read the KibaOS Wiki (opens in new tab)">Wiki</a>
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba/issues" target="_blank" rel="noopener noreferrer" aria-label="Report an issue on GitHub (opens in new tab)">Report Issue</a>
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="View the KibaOS source code on GitHub (opens in new tab)">GitHub</a>
