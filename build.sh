...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .btn { display:inline-block; background:var(--accent); color:#fff; border-radius:10px; padding:9px 20px; text-decoration:none; font-size:.88rem; font-weight:600; margin:6px 6px 0 0; transition: transform 0.1s, background 0.12s, box-shadow 0.1s; cursor: pointer; }
