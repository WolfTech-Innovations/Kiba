...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:focus-visible { outline:none; box-shadow:0 0 0 3px var(--accent); transition: transform .15s, box-shadow .15s; }
...
<section>
  ...
  <br>
  <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" aria-label="Open KibaOS Wiki">Wiki</a>
