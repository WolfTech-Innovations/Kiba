...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:hover, .card:focus-within { transform:translateY(-5px); box-shadow:0 12px 40px rgba(0,100,160,0.18); }
...
<section>
  ...
  <br>
  <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" target="_blank" rel="noopener noreferrer" aria-label="View the KibaOS Wiki in a new tab">Wiki</a>
  ...
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="View the source code on GitHub in a new tab">GitHub</a>
