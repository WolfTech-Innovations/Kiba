...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .btn.secondary:focus-visible { outline-color: var(--border); }
...
<main>
  ...
  <section>
    ...
    <br>
    <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" target="_blank" rel="noopener noreferrer" aria-label="Visit KibaOS Wiki (opens in new tab)">📖 Wiki</a>
    ...
    <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="View Source on GitHub (opens in new tab)">💻 GitHub</a>
