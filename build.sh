...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:hover { transform:translateY(-3px); box-shadow:0 8px 32px rgba(0,0,0,0.40); }
...
<section>
  ...
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba/issues" aria-label="Report an Issue">🐛 Report Issue</a>
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" aria-label="Visit KibaOS on GitHub">🐙 GitHub</a>
