...
<section>
  ...
  <br>
  <a class="btn" href="https://github.com/WolfTech-Innovations/Kiba/blob/main/WIKI.md" target="_blank" rel="noopener noreferrer" aria-label="Read the KibaOS Wiki (opens in a new tab)">📖 Wiki</a>
  ...
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba" target="_blank" rel="noopener noreferrer" aria-label="Visit KibaOS GitHub repository (opens in a new tab)">💻 GitHub</a>
