...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .card:hover { transform:translateY(-4px); box-shadow:0 8px 32px rgba(0,100,160,0.16); }
...
<main>
  <div class="card-row" role="list" aria-label="Key features of KibaOS">
  ...
  <a class="btn secondary" href="https://github.com/WolfTech-Innovations/Kiba/issues" aria-label="Report an issue or suggest a feature on GitHub">Report Issue</a>
