...
## 2026-06-16 - Dracula Micro-UX for Welcome Screen
**Learning:** Transitioning the Welcome screen to the Dracula palette improves visual consistency with the rest of the OS. Using box-shadow for focus indicators provides a smoother, more accessible experience than standard outlines, especially on darker themes. Tactile feedback through `:active` scaling and smooth transitions on hover significantly improves the "perceived quality" of simple HTML components.
**Action:** Use Dracula design tokens (#282a36, #44475a, #bd93f9) and tactile feedback (scale/shadow) for all first-party HTML UI components.
