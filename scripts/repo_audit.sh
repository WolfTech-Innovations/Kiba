...
# chpasswd without -e (indicates plaintext password)
if grep -r "chpasswd" . --exclude-dir=.git --exclude-dir=.Jules --exclude="workflows_to_add.txt" --exclude="*.md" | grep -v "\-e"; then
