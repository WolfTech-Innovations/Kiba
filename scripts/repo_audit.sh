...
# Plaintext chpasswd (missing -e/--encrypted)
if grep -r "chpasswd" . --exclude-dir=.git --exclude="repo_audit.sh" --exclude="*.md" --exclude="workflows_to_add.txt" | grep -vE "\-e|--encrypted"; then
