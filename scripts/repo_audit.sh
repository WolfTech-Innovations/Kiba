...
# chpasswd plaintext
if grep -r "chpasswd" . --exclude-dir=.git --exclude-dir=.github --exclude-dir=.Jules --exclude="*.md" --exclude="repo_audit.sh" --exclude="workflows_to_add.txt" | grep -v "chpasswd -e"; then
