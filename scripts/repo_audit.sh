...
# chmod 777
if grep -rE "chmod (0?777|777)" . --exclude-dir=.git --exclude-dir=.Jules --exclude="scripts/repo_audit.sh" --exclude="*.md" --exclude="workflows_to_add.txt" | grep -v "repo_audit.sh"; then
