...
Generated on Wed May 13 11:05:04 UTC 2026
...
| Advanced Issue Triage | `.github/workflows/advanced-issue-triage.yml` |
| Advanced Labeler | `.github/workflows/advanced-labeler.yml` |
| Aggregate Release Notes | `.github/workflows/aggregate-release-notes.yml` |
...
| Audit Build Absolute Paths Utilities | `.github/workflows/audit-build-absolute-paths-utilities.yml` |
| Audit Build Apkbuild Options Check | `.github/workflows/audit-build-apkbuild-options-check.yml` |
| Audit Build Apt Get No Upgrade | `.github/workflows/audit-build-apt-get-no-upgrade.yml` |
| Audit Build Apt No Recommends | `.github/workflows/audit-build-apt-no-recommends.yml` |
| Audit Build Apt Yes | `.github/workflows/audit-build-apt-yes.yml` |
| Audit Build Awk V | `.github/workflows/audit-build-awk-v.yml` |
| Audit Build Breezerc Purple Shadow | `.github/workflows/audit-build-breezerc-purple-shadow.yml` |
| Audit Build Calamares Sidebar | `.github/workflows/audit-build-calamares-sidebar-bg.yml` |
| Audit Build Chown H | `.github/workflows/audit-build-chown-h.yml` |
| Audit Build Chromium Home | `.github/workflows/audit-build-chromium-home.yml` |
| Audit Build Clean Tmp | `.github/workflows/audit-build-clean-tmp.yml` |
| Audit Build Cp A | `.github/workflows/audit-build-cp-a.yml` |
| Audit Build Curl Max Time | `.github/workflows/audit-build-curl-max-time.yml` |
| Audit Build Debian Trixie Debootstrap | `.github/workflows/audit-build-debian-trixie-debootstrap.yml` |
| Audit Build Dpkg No Force All | `.github/workflows/audit-build-dpkg-no-force-all.yml` |
| Audit Build Dracula Bg Hex | `.github/workflows/audit-build-dracula-bg-hex.yml` |
| Audit Build Dracula Hex | `.github/workflows/audit-build-dracula-hex.yml` |
| Audit Build Eatmydata Usage | `.github/workflows/audit-build-eatmydata-usage.yml` |
| Audit Build Find Delete Name | `.github/workflows/audit-build-find-delete-name.yml` |
| Audit Build Git No Tags | `.github/workflows/audit-build-git-no-tags.yml` |
| Audit Build Git Shallow Clone | `.github/workflows/audit-build-git-shallow-clone.yml` |
| Audit Build Groupadd Force | `.github/workflows/audit-build-groupadd-force.yml` |
| Audit Build Grub Gfxterm | `.github/workflows/audit-build-grub-gfxterm.yml` |
| Audit Build Grub Timeout 5 | `.github/workflows/audit-build-grub-timeout-5.yml` |
| Audit Build GRUB Timeout | `.github/workflows/audit-build-grub-timeout-check.yml` |
| Audit Build Grub Timeout Consistency | `.github/workflows/audit-build-grub-timeout-consistency.yml` |
| Audit Build Grub Video Modules | `.github/workflows/audit-build-grub-video-modules.yml` |
| Audit Build Gzip 9 | `.github/workflows/audit-build-gzip-9.yml` |
| Audit Build Hostname Kibatv | `.github/workflows/audit-build-hostname-kibatv.yml` |
| Audit Build Idempotent Mkdir | `.github/workflows/audit-build-idempotent-mkdir.yml` |
| Audit Build Install Dm755 | `.github/workflows/audit-build-install-dm755.yml` |
| Audit Build Kdeglobals Single Click | `.github/workflows/audit-build-kdeglobals-single-click.yml` |
| Audit Build Kernel Purge Order | `.github/workflows/audit-build-kernel-purge-order.yml` |
| Audit Build Konsole Opacity 095 | `.github/workflows/audit-build-konsole-opacity-095.yml` |
| Audit Build Konsole Opacity | `.github/workflows/audit-build-konsole-opacity-check.yml` |
| Audit Build Kwin Blur 12 | `.github/workflows/audit-build-kwin-blur-12.yml` |
| Audit Build Kwin Border Size None | `.github/workflows/audit-build-kwin-border-size-none.yml` |
| Audit Build Kwin Compositing Enabled | `.github/workflows/audit-build-kwin-compositing-enabled.yml` |
| Audit Build Mkdir M | `.github/workflows/audit-build-mkdir-m.yml` |
| Audit Build Mksquashfs Zstd | `.github/workflows/audit-build-mksquashfs-zstd.yml` |
| Audit Build Mount Nbd Max Part | `.github/workflows/audit-build-mount-nbd-max-part.yml` |
| Audit Build Mtools Reproducibility | `.github/workflows/audit-build-mtools-reproducibility.yml` |
| Audit Build No Read Interactive | `.github/workflows/audit-build-no-read-interactive.yml` |
| Audit Build No Sudo | `.github/workflows/audit-build-no-sudo.yml` |
| Audit Build OS Identity | `.github/workflows/audit-build-os-identity.yml` |
| Audit Build Os Release Id | `.github/workflows/audit-build-os-release-id.yml` |
| Audit Build Os Release Pretty Name | `.github/workflows/audit-build-os-release-pretty-name.yml` |
| Audit Build Parallel Jobs Enforcement | `.github/workflows/audit-build-parallel-jobs-enforcement.yml` |
| Audit Build Password Length | `.github/workflows/audit-build-password-length.yml` |
| Audit Build Pip No Cache | `.github/workflows/audit-build-pip-no-cache.yml` |
| Audit Build Plasma Theme Name | `.github/workflows/audit-build-plasma-theme-name.yml` |
| Audit Build Plymouth Background Color | `.github/workflows/audit-build-plymouth-background-color.yml` |
| Audit Build Plymouth Color | `.github/workflows/audit-build-plymouth-color.yml` |
| Audit Build Plymouth Module Script | `.github/workflows/audit-build-plymouth-module-script.yml` |
| Audit Build Pmbootstrap As Root | `.github/workflows/audit-build-pmbootstrap-as-root.yml` |
| Audit Build Pmbootstrap Config Jobs | `.github/workflows/audit-build-pmbootstrap-config-jobs.yml` |
| Audit Build Pmbootstrap Init Assume Yes | `.github/workflows/audit-build-pmbootstrap-init-assume-yes.yml` |
| Audit Build Pmbootstrap Status Stdout | `.github/workflows/audit-build-pmbootstrap-status-stdout.yml` |
| Audit Build Qemu Cleanup | `.github/workflows/audit-build-qemu-cleanup.yml` |
| Audit Build Rm No V | `.github/workflows/audit-build-rm-no-v.yml` |
| Audit Build Sddm Autologin User | `.github/workflows/audit-build-sddm-autologin-user.yml` |
| Audit Build SDDM Config | `.github/workflows/audit-build-sddm-config.yml` |
| Audit Build Sed No Bak | `.github/workflows/audit-build-sed-no-bak.yml` |
| Audit Build Sha256sum Iso | `.github/workflows/audit-build-sha256sum-iso.yml` |
| Audit Build Splash QML Text | `.github/workflows/audit-build-splash-qml-text.yml` |
| Audit Build Squashfs Optimization | `.github/workflows/audit-build-squashfs-optimization.yml` |
| Audit Build Su C Eatmydata | `.github/workflows/audit-build-su-c-eatmydata.yml` |
| Audit Build Su C Grouping | `.github/workflows/audit-build-su-c-grouping.yml` |
| Audit Build Tar P | `.github/workflows/audit-build-tar-p.yml` |
| Audit Build Umount Lazy | `.github/workflows/audit-build-umount-lazy.yml` |
| Audit Build Useradd System | `.github/workflows/audit-build-useradd-system.yml` |
| Audit Build Wget Nv | `.github/workflows/audit-build-wget-nv.yml` |
| Audit Build Xargs 0 | `.github/workflows/audit-build-xargs-0.yml` |
| Audit Build Xorriso Volid Kibatv | `.github/workflows/audit-build-xorriso-volid-kibatv.yml` |
| Audit Build Zenity Title | `.github/workflows/audit-build-zenity-title.yml` |
| Audit Build Zsh Alias | `.github/workflows/audit-build-zsh-alias-check.yml` |
...
| Audit Markdown KibaTV Consistency | `.github/workflows/audit-markdown-kibatv-consistency.yml` |
...
| Audit Python Assert Is Not Tuple | `.github/workflows/audit-python-assert-is-not-tuple.yml` |
| Audit Python Bare Except | `.github/workflows/audit-python-bare-except.yml` |
| Audit Python Datetime Now Utc | `.github/workflows/audit-python-datetime-now-utc.yml` |
| Audit Python Docstring Coverage | `.github/workflows/audit-python-docstring-coverage.yml` |
| Audit Python Docstring Style | `.github/workflows/audit-python-docstring-style.yml` |
| Audit Python Enumerate Usage | `.github/workflows/audit-python-enumerate-usage.yml` |
| Audit Python F-String Preference | `.github/workflows/audit-python-f-string-pref.yml` |
| Audit Python Is None Strict | `.github/workflows/audit-python-is-none-strict.yml` |
| Audit Python Isinstance Over Type | `.github/workflows/audit-python-isinstance-over-type.yml` |
| Audit Python Logging Format Interpolation | `.github/workflows/audit-python-logging-format-interpolation.yml` |
| Audit Python Mutable Default Args | `.github/workflows/audit-python-mutable-default-args.yml` |
| Audit Python No Print | `.github/workflows/audit-python-no-print.yml` |
| Audit Python No Return In Finally | `.github/workflows/audit-python-no-return-in-finally.yml` |
| Audit Python Open Encoding UTF8 | `.github/workflows/audit-python-open-encoding-utf8.yml` |
| Audit Python Os Environ Get Usage | `.github/workflows/audit-python-os-environ-get-usage.yml` |
| Audit Python Pathlib Usage | `.github/workflows/audit-python-pathlib-usage.yml` |
| Audit Python Redundant Parentheses | `.github/workflows/audit-python-redundant-parentheses.yml` |
| Audit Python Requests Timeout Presence | `.github/workflows/audit-python-requests-timeout-presence.yml` |
| Audit Python Subprocess Run Check | `.github/workflows/audit-python-subprocess-run-check.yml` |
| Audit Python Subprocess Shell False | `.github/workflows/audit-python-subprocess-shell-false.yml` |
...
| Audit Shell Cd Exit | `.github/workflows/audit-shell-cd-exit.yml` |
| Audit Shell Curl Secure | `.github/workflows/audit-shell-curl-secure.yml` |
| Audit Shell Double Brackets | `.github/workflows/audit-shell-double-brackets.yml` |
| Audit Shell Export Usage | `.github/workflows/audit-shell-export-usage.yml` |
| Audit Shell Function Alias Comment | `.github/workflows/audit-shell-func-alias-comment.yml` |
...
| Audit Shell No Eval Strict | `.github/workflows/audit-shell-no-eval-strict.yml` |
| Audit Shell No Set X Strict | `.github/workflows/audit-shell-no-set-x-strict.yml` |
| Audit Shell Portable Command V | `.github/workflows/audit-shell-portable-command-v.yml` |
...
| Audit Shell Shebang No Space | `.github/workflows/audit-shell-shebang-no-space.yml` |
| Audit Shell ShellCheck Disable Comment | `.github/workflows/audit-shell-shellcheck-disable-comment.yml` |
| Audit Shell Unquoted Heredoc Delimiter | `.github/workflows/audit-shell-unquoted-heredoc-delimiter.yml` |
| Audit Shell Variable Quoting Strict | `.github/workflows/audit-shell-variable-quoting-strict.yml` |
...
| Auto Welcome New Contributor | `.github/workflows/auto-welcome-new-contributor-kiba.yml` |
| Automated Issue Label Check | `.github/workflows/automated-issue-label-check.yml` |
| Automated Repo Health Report | `.github/workflows/automated-repo-health-report.yml` |
| Bandit | `.github/workflows/bandit.yml` |
| Branch Name Enforcer | `.github/workflows/branch-name-enforcer.yml` |
| Branding Assets Validator | `.github/workflows/branding-assets-validator.yml` |
...
| Check Shell Path Quoting | `.github/workflows/check-shell-path-quoting.yml` |
...
| Contributor License Agreement Check | `.github/workflows/contributor-license-agreement-check.yml` |
...
| Desktop Entry Validator | `.github/workflows/desktop-entry-validator.yml` |
| Doc Spelling Common Mistakes | `.github/workflows/doc-spelling-common-mistakes.yml` |
| Doc Trailing Whitespace Enforcer | `.github/workflows/doc-trailing-whitespace-enforcer.yml` |
...
| Docs No Broken Image Links | `.github/workflows/docs-no-broken-image-links.yml` |
| Docs No Broken Internal Anchors | `.github/workflows/docs-no-broken-internal-anchors.yml` |
| Docs No Long Lines in Tables | `.github/workflows/docs-no-long-lines-in-tables.yml` |
| Docs No Placeholder Text | `.github/workflows/docs-no-placeholder-text.yml` |
| Docs Related Reading Audit | `.github/workflows/docs-related-reading-audit.yml` |
...
| Documentation Version Audit | `.github/workflows/documentation-version-audit.yml` |
| Dracula Hex Validator | `.github/workflows/dracula-hex-validator.yml` |
| Draft PR Stale Notifier | `.github/workflows/draft-pr-stale-notifier.yml` |
| Duplicate Dependency Checker | `.github/workflows/duplicate-dependency-checker.yml` |
| Empty File Checker | `.github/workflows/empty-file-checker.yml` |
| Enforce APT Signed-By | `.github/workflows/enforce-apt-signed-by.yml` |
| Ensure Notes Gitkeep | `.github/workflows/ensure-notes-gitkeep.yml` |
| Environment Variable Leak Check | `.github/workflows/environment-variable-leak-check.yml` |
| First PR Congratulator | `.github/workflows/first-pr-congratulator.yml` |
...
| Issue Escalation Policy | `.github/workflows/issue-escalation-policy.yml` |
| Issue Milestone Presence Check | `.github/workflows/issue-milestone-presence-check.yml` |
| Issue Milestone Reminder | `.github/workflows/issue-milestone-reminder.yml` |
| Issue Necro-Posting Prevention | `.github/workflows/issue-necro-posting-prevention.yml` |
| Issue Needs-Info Auto-Closer | `.github/workflows/issue-needs-info-auto-closer.yml` |
| Issue No Body Checker | `.github/workflows/issue-no-body-checker.yml` |
| Issue Priority Auto-Labeler | `.github/workflows/issue-priority-auto-labeler.yml` |
| Issue Repro Steps Validator | `.github/workflows/issue-repro-steps-validator.yml` |
| Issue Stale Collaboration Ping | `.github/workflows/issue-stale-collaboration-ping.yml` |
| Issue Stale Ping | `.github/workflows/issue-stale-ping.yml` |
| Issue Template Audit | `.github/workflows/issue-template-audit.yml` |
| Issue Template Completeness | `.github/workflows/issue-template-completeness-check.yml` |
| Issue Template Mandatory Sections | `.github/workflows/issue-template-mandatory-sections.yml` |
| Issue Template Validator | `.github/workflows/issue-template-validator.yml` |
| Issue Title No Period | `.github/workflows/issue-title-no-period.yml` |
| Issue Use Case Enforcer | `.github/workflows/issue-use-case-enforcer.yml` |
| JSON Lint | `.github/workflows/json-lint.yml` |
| JSON Schema Validator | `.github/workflows/json-schema-validator.yml` |
| Jules Automatic Fixer Pipeline | `.github/workflows/jules-pipeline.yml` |
...
| License Compliance Audit | `.github/workflows/license-compliance-audit.yml` |
...
| License Year Consistency Check | `.github/workflows/license-year-consistency-check.yml` |
| License Year Updater | `.github/workflows/license-year-updater.yml` |
| Lock Threads | `.github/workflows/lock-threads.yml` |
| Manual Release | `.github/workflows/manual-release.yml` |
| Markdown Bold Style Checker | `.github/workflows/markdown-bold-style-checker.yml` |
| Markdown Code Language Requirement | `.github/workflows/markdown-code-lang-requirement.yml` |
| Markdown Header Hierarchy Check | `.github/workflows/markdown-header-hierarchy-check.yml` |
| Markdown Internal Link Checker | `.github/workflows/markdown-internal-link-checker.yml` |
| Markdown Link Format Audit | `.github/workflows/markdown-link-format-audit.yml` |
| Markdown Link Spacing Validator | `.github/workflows/markdown-link-spacing-validator.yml` |
| Markdown Lint | `.github/workflows/markdown-lint.yml` |
| Markdown List Style Enforcer | `.github/workflows/markdown-list-style-enforcer.yml` |
| Markdown No Empty Code Blocks | `.github/workflows/markdown-no-empty-code-blocks.yml` |
| Markdown No Empty Links Check | `.github/workflows/markdown-no-empty-links-check.yml` |
| Markdown No Orphan Headers | `.github/workflows/markdown-no-orphan-headers.yml` |
| Markdown Single H1 Validator | `.github/workflows/markdown-single-h1-validator.yml` |
| Markdown Style Enforcer | `.github/workflows/markdown-style-enforcer.yml` |
| MegaLinter | `.github/workflows/mega-linter.yml` |
| Mermaid Diagram Syntax Check | `.github/workflows/mermaid-diagram-syntax-check.yml` |
| Mermaid Syntax Enhancer | `.github/workflows/mermaid-syntax-enhancer.yml` |
| Metadata Consistency Report | `.github/workflows/metadata-consistency-report.yml` |
| Mktemp Assignment Validator | `.github/workflows/mktemp-assignment-validator.yml` |
...
| PR Conflict Notifier | `.github/workflows/pr-conflict-notifier.yml` |
| PR Conventional Commits Title Validator | `.github/workflows/pr-conventional-commits-title-validator.yml` |
| PR Description Length Check | `.github/workflows/pr-description-length-check.yml` |
| PR Description Quality Enforcer | `.github/workflows/pr-description-quality-enforcer.yml` |
| PR Description Validator | `.github/workflows/pr-description-validator.yml` |
| PR Label Conflict Checker | `.github/workflows/pr-label-conflict-checker.yml` |
...
| PR No Revert Commits Check | `.github/workflows/pr-no-revert-commits-check.yml` |
...
| QML Module Import Validator | `.github/workflows/qml-module-import-validator.yml` |
| README Badge Synchronizer | `.github/workflows/readme-badge-synchronizer.yml` |
| README Badge Validator | `.github/workflows/readme-badge-validator.yml` |
| README Badges Alignment | `.github/workflows/readme-badges-alignment-check.yml` |
| README Contribution Check | `.github/workflows/readme-contribution-section-check.yml` |
| README Docs Link Validator | `.github/workflows/readme-link-to-docs-validator.yml` |
| README Title Centering Check | `.github/workflows/readme-title-centering-check.yml` |
| Release Drafter | `.github/workflows/release-drafter.yml` |
| Release Notes Autodraft | `.github/workflows/release-notes-autodraft.yml` |
| Release Notes Naming Validator | `.github/workflows/release-notes-naming-validator.yml` |
...
| Repo Forbidden Directory Structure | `.github/workflows/repo-forbidden-directory-structure.yml` |
| Repo Git Conflict Marker Check | `.github/workflows/repo-git-conflict-marker-check.yml` |
| Repo Hidden File Audit | `.github/workflows/repo-hidden-file-audit.yml` |
| Repo Large File Prevention | `.github/workflows/repo-large-file-prevention.yml` |
| Repo No Backup Files Audit | `.github/workflows/repo-no-backup-files-audit.yml` |
| Repo No Symlink To Abs | `.github/workflows/repo-no-symlink-to-abs.yml` |
...
| Shell Glob Prevention Audit | `.github/workflows/shell-glob-prevention-audit.yml` |
...
| Stale Closer | `.github/workflows/stale-closer.yml` |
| Stale Issue Cleanup Notifier | `.github/workflows/stale-issue-cleanup-notifier.yml` |
| Stale Issue Soft Closer | `.github/workflows/stale-issue-soft-closer.yml` |
| Starship Init Quoted Eval | `.github/workflows/starship-init-quoted-eval.yml` |
| Step Security | `.github/workflows/step-security.yml` |
...
| Upstream Debian Monitor | `.github/workflows/upstream-debian-monitor.yml` |
...
| Weekly Repo Activity Summary | `.github/workflows/weekly-repo-activity-summary.yml` |
| Wiki Link Integrity | `.github/workflows/wiki-link-integrity.yml` |
| Workflow Action Version Consistency | `.github/workflows/workflow-action-version-consistency.yml` |
| Workflow Concurrency Audit | `.github/workflows/workflow-concurrency-audit.yml` |
| Workflow Deprecated Runners Audit | `.github/workflows/workflow-deprecated-runners-audit.yml` |
| Workflow Dispatch Input Description Check | `.github/workflows/workflow-dispatch-input-description-check.yml` |
| Workflow Documentation Generator | `.github/workflows/workflow-documentation-generator.yml` |
| Workflow Env Naming Convention | `.github/workflows/workflow-env-naming-convention.yml` |
| Workflow Failure Trends | `.github/workflows/workflow-failure-trends.yml` |
| Workflow Job Concurrency Key Audit | `.github/workflows/workflow-job-concurrency-key-audit.yml` |
| Workflow Job ID Kebab Case | `.github/workflows/workflow-job-id-kebab-case.yml` |
| Workflow Job Timeout Enforcer | `.github/workflows/workflow-job-timeout-enforcer.yml` |
| Workflow Naming Consistency Check | `.github/workflows/workflow-naming-consistency-check.yml` |
| Workflow No Redundant Checkout | `.github/workflows/workflow-no-redundant-checkout.yml` |
| Workflow Permission Least Privilege | `.github/workflows/workflow-permission-least-privilege.yml` |
| Workflow Permissions Audit | `.github/workflows/workflow-permissions-audit.yml` |
| Workflow Redundancy Audit | `.github/workflows/workflow-redundancy-audit.yml` |
| Workflow Run Cleanup | `.github/workflows/workflow-run-cleanup.yml` |
| Workflow Secret Usage Audit | `.github/workflows/workflow-secret-usage-audit.yml` |
| Workflow Shell Spec Check | `.github/workflows/workflow-shell-specification-check.yml` |
| Workflow Step ID Kebab Case | `.github/workflows/workflow-step-id-kebab-case.yml` |
| Workflow Step ID No Duplicates | `.github/workflows/workflow-step-id-no-duplicates.yml` |
| Workflow Step Name Capitalization | `.github/workflows/workflow-step-name-capitalization.yml` |
...
| Zenity Literal Newline Checker | `.github/workflows/zenity-literal-newline-checker.yml` |
