...
Generated on Mon May 25 17:37:34 UTC 2026
...
| Analyze Build Efficiency | `./.github/workflows/analyze-build-efficiency.yml` |
...
| Audit Build SH Consistency | `./.github/workflows/audit-build-sh-consistency.yml` |
...
| Audit Python Import Star | `./.github/workflows/audit-python-import-star.yml` |
...
| Audit Python Mutable Defaults | `./.github/workflows/audit-python-mutable-defaults.yml` |
...
| Audit Python Print Statements | `./.github/workflows/audit-python-print-statements.yml` |
...
| Audit Repo No Pyc | `./.github/workflows/audit-repo-no-pyc.yml` |
...
| Audit Shell Tool Modernization | `./.github/workflows/audit-shell-tool-modernization.yml` |
...
| Audit Workflow Step Id Format | `./.github/workflows/audit-workflow-step-id-format.yml` |
...
| Branding Asset Specification Validator | `./.github/workflows/branding-asset-specification-validator.yml` |
| Branding Assets Validator | `./.github/workflows/branding-assets-validator.yml` |
| Branding Contrast Accessibility Audit | `./.github/workflows/branding-contrast-accessibility-audit.yml` |
...
| Contributor Milestone Celebration | `./.github/workflows/contributor-milestone-celebration.yml` |
...
| Detect Duplicate Package Intent | `./.github/workflows/detect-duplicate-package-intent.yml` |
...
| Docs Navigation Sitemap Sync | `./.github/workflows/docs-navigation-sitemap-sync.yml` |
| Docs No Broken External Anchors | `./.github/workflows/docs-no-broken-external-anchors.yml` |
...
| Docs No Todo In Readme | `./.github/workflows/docs-no-todo-in-readme.yml` |
| Docs Readability Audit | `./.github/workflows/docs-readability-audit.yml` |
...
| Enforce Branch Naming | `./.github/workflows/enforce-branch-naming.yml` |
| Enforce Dracula Comment Hex | `./.github/workflows/enforce-dracula-comment-hex.yml` |
| Enforce Job ID Kebab Case | `./.github/workflows/enforce-job-id-kebab-case.yml` |
| Enforce Md List Marker | `./.github/workflows/enforce-md-list-marker.yml` |
| Enforce Shell Modernization | `./.github/workflows/enforce-shell-modernization.yml` |
| Enforce Shell Pipefail Strict | `./.github/workflows/enforce-shell-pipefail-strict.yml` |
| Enforce Shell Readonly Const | `./.github/workflows/enforce-shell-readonly-const.yml` |
...
| ISO Duplicate Content Scanner | `./.github/workflows/iso-duplicate-content-scanner.yml` |
...
| Issue Hotness Priority Sync | `./.github/workflows/issue-hotness-priority-sync.yml` |
...
| Markdown Link No Space | `./.github/workflows/markdown-link-no-space.yml` |
...
| Markdown List Consistency V4 | `./.github/workflows/markdown-list-consistency-v4.yml` |
...
| Milestone Burndown Visualizer | `./.github/workflows/milestone-burndown-visualizer.yml` |
| Milestone Due Monitor | `./.github/workflows/milestone-due-monitor.yml` |
...
| Monitor Arch Keyring | `./.github/workflows/monitor-arch-keyring.yml` |
...
| PR Conflict Resolution Assistant | `./.github/workflows/pr-conflict-resolution-assistant.yml` |
...
| PR Package Impact Report | `./.github/workflows/pr-package-impact-report.yml` |
...
| Release Draft Content Sync | `./.github/workflows/release-draft-content-sync.yml` |
...
| Repo No Exec On Configs | `./.github/workflows/repo-no-exec-on-configs.yml` |
| Repo No Mixed Indentation | `./.github/workflows/repo-no-mixed-indentation.yml` |
...
| Source File License Audit | `./.github/workflows/source-file-license-audit.yml` |
...
| Suggest Acknowledgment Updates | `./.github/workflows/suggest-acknowledgment-updates.yml` |
| Systemd Hardening Scorecard | `./.github/workflows/systemd-hardening-scorecard.yml` |
...
| Workflow Consistent Timeout | `./.github/workflows/workflow-consistent-timeout.yml` |
| Workflow Deprecated Runners Audit | `./.github/workflows/workflow-deprecated-runners-audit.yml` |
| Workflow Dispatch Input Audit | `./.github/workflows/workflow-dispatch-input-audit.yml` |
...
| Workflow No Top Level Env | `./.github/workflows/workflow-no-top-level-env.yml` |
...
| Workflow Semantic Redundancy Check | `./.github/workflows/workflow-semantic-redundancy-check.yml` |
